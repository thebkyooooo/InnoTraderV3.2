...
const columns: ColDef<StockQuote>[] = [
  ...
  { field: 'high', headerName: '고가', width: 100, cellStyle: () => ({ ...right, color: UP }),   valueFormatter: p => fmt(p.value), headerClass: 'header-right' },
  { field: 'low',  headerName: '저가', width: 100, cellStyle: () => ({ ...right, color: DOWN }), valueFormatter: p => fmt(p.value), headerClass: 'header-right' },
