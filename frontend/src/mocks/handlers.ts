...
export const handlers = [...healthHandlers, ...authHandlers, ...adminHandlers, ...stockMasterHandlers, ...quoteHandlers, ...chartHandlers, ...marketHandlers, ...watchlistHandlers, ...accountHandlers, ...holdingHandlers, ...orderHandlers]
