...
export function StockDetailCard({ symbol }: StockDetailCardProps) {
  ...
  const rowsGrp01: { label: string; value: string; color?: string }[] = [
  ...
  const rowsGrp02: { label: string; value: string; color?: string }[] = [
  ...
  const rowsGrp03: { label: string; value: string; color?: string }[] = [
